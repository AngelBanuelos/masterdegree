...
public class TernaryTree {
    ...
    public void addNode(int value1, int value2) {
        if (root == null) {
            root = new TernaryNode(value1, value2);
        } else {
            TernaryNode node = new TernaryNode(value1, value2);
            addNode(node, root);
        }
    }

    public String search(TernaryNode node, int value) {
        if (node == null) {
            return "";
        }
    ...
    private void addNode(TernaryNode node, TernaryNode root) {
        if (node == null) {
            return;
        }
